"""
Federated Model Architecture for Client Application

This module defines the neural network architecture used for the local model
in the federated learning system. The model is IDENTICAL to the central server
model to ensure weight compatibility during aggregation.
"""
